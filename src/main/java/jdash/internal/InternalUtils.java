...
public final class InternalUtils {
    ...
    /**
     * Extracts a triplet (a set of exactly 3 integer values) from the given raw data string. The string is expected to
     * match the regex:
     *
     * <pre>
     * [0-9]+:[0-9]+:[0-9]+
    ...
    public static Tuple3<Integer, Integer, Integer> extractPageInfo(String raw) {
        ...
        return Tuples.of(Integer.parseInt(StringUtils.defaultIfEmpty(pageInfo[0], "0")),
                Integer.parseInt(StringUtils.defaultIfEmpty(pageInfo[1], "0")),
                Integer.parseInt(StringUtils.defaultIfEmpty(pageInfo[2], "0")));
    }
