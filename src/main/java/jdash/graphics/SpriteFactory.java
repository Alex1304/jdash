...
public class SpriteFactory {
    ...
    /**
     * Creates a new sprite factory. This method will load the sprite images in memory, that's why an {@link
     * IOException} needs to be checked when calling this method.
     *
