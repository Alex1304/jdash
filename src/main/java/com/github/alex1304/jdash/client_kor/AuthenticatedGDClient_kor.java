...
public final class AuthenticatedGDClient extends AbstractGDClient {
	...
	/**
	 * Gets the private messages of the account that this client is logged on.(이 클라이언트가 로그온한 계정의 개인 메시지를 가져오십시오.)
	 * 
	...
	/**
	 * Sends a private message to a user.(사용자에게 개인 메시지 보내기)
	 * 
	...
	/**
	 * Sends a private message to a user by their ID.(개인 메시지를 ID로 사용자에게 전송)
	 * 
	...
	/**
	 * Gets the account ID of this client(이 클라이언트의 계정 ID 가져오기)
	 * 
	...
	/**
	 * Gets the player ID of this client(이 클라이언트의 플레이어 ID 가져오기)
	 * 
	...
	/**
	 * Gets the username of the GD account this client is logged in(이 클라이언트가 로그인한 GD 계정의 사용자 이름 가져오기)
	 * 
	 * @return the username
	 * @throws IllegalStateException if this client is unauthenticated
	 */
	...
	/**
	 * Gets the GD account password of this client(이 클라이언트의 GD 계정 암호를 가져오십시오.)
	 * 
	 * @return the password
