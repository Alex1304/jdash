...
public final class LegacySpriteFactory implements SpriteFactory {
    ...
    private LegacySpriteFactory(BufferedImage spriteImg, Map<String, List<Sprite>> sprites) {
    ...
    public static SpriteFactory create() {
        try {
            ...
            var sprites = loadSprites(new Configurations()
                    .fileBased(XMLPropertyListConfiguration.class, LegacySpriteFactory.class
                            .getResource("/GJ_GameSheet03-uhd.plist")));
            return new LegacySpriteFactory(spriteImg, sprites);
